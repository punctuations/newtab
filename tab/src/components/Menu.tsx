      ...
      {settings.visible && (
        <>
          ...
          <motion.div
            ...
            className="z-40 bg-white dark:bg-black absolute transform -translate-y-1/2 -translate-x-1/2 top-1/2 left-1/2 flex flex-col items-start space-y-4 shadow-2xl dark:shadow-none dark:border border-gray-700 rounded-md px-5 py-6"
          >
